...
<div class="contents">
    ...
    <a href="/hosts" class="kpi-card">
        ...
        <p class="kpi-delta mt-auto pt-1 {stats.offlineHosts > 0 ? 'text-destructive' : 'text-success'}">
    ...
    <div class="kpi-card">
        ...
        <p class="kpi-value text-foreground tabular-nums">
            {stats.loadAvg.toFixed(2)} <span class="kpi-unit">· {stats.loadAvg5.toFixed(2)} · {stats.loadAvg15.toFixed(2)}</span>
        </p>
        <div class="kpi-trend">
